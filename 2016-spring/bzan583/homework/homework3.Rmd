...
*Due*: Monday, Feb 8, 2016 by 5:00pm.
...
4. (10 pts) If we had a remote named `origin` (say on GitHub), what command would send our changes to the remote for the `master` branch?  (Hint: not `pull` but...)
